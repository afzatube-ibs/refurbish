...
class ProductPreviewService
{
    ...
    public function __construct(
        ...
        private readonly ProductHealthResolver $healthResolver = new ProductHealthResolver(),
    ) {}
    ...
    {
        return $this->healthResolver->applyToProducts($products);
    }
    ...
    {
        return $this->healthResolver->optionLowWarning($option, $parentLowWarning);
    }
    ...
    public function buildSummary(array $rawProducts, array $products): array
    {
        ...
        $dashboardCounts = $this->healthResolver->buildDashboardCounts($products);
        ...
        return [
            ...
            'variant_rows' => $dashboardCounts['variant_rows'],
            'products_with_option_images' => $optionImagesOk,
            'variant_ibs_models_present' => $variantModelsOk,
            'health_ok' => $dashboardCounts['health_ok'],
            'health_needs_work' => $dashboardCounts['health_needs_work'],
        ];
    }
