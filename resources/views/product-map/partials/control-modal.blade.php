    ...
    <div class="modal-panel modal-panel-product-control pcc-v202-panel" role="dialog" aria-labelledby="pccModalTitle" aria-modal="true">
        <div class="pcc-v202-header">
            <div class="pcc-modal-heading">
                <h2 class="pcc-modal-title" id="pccModalTitle">Edit Supplier Product</h2>
            </div>
        ...
        <div class="pcc-tabs pcc-v202-tabs" role="tablist">
            <button type="button" class="pcc-tab is-active" data-pcc-tab="details" role="tab" aria-selected="true">Product Fields</button>
            ...
            <div class="pcc-tab-panel is-active pcc-v202-tab-panel" data-pcc-panel="details">
                <div class="pcc-v202-workspace" id="pccWorkspace">
                    <div class="pcc-v202-top-split">
                        <section class="pcc-v202-snapshot" aria-label="Lokkisona Snapshot">
                            ...
                            <div class="pcc-v202-snapshot-body">
                                <h3 class="pcc-v202-section-title">Lokkisona Snapshot</h3>
                        ...
                        <section class="pcc-v202-supplier" id="pccVendorMappingCard" aria-label="IBS Supplier Fields">
                            <h3 class="pcc-v202-section-title">IBS Supplier Fields</h3>
                ...
                <div class="pcc-v202-footer">
                    <button type="button" class="btn btn-secondary btn-sm" data-close-control-modal>Cancel</button>
                    <button type="submit" class="btn btn-primary" id="pccSaveBtn" disabled>Save Changes</button>
                </div>
            </div>
