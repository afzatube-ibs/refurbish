...
class PayableServiceBalanceMeaningTest extends TestCase
{
    ...
    {
        $this->assertSame('Payable to supplier', $this->service->balanceMeaning(150.5));
    ...
    {
        $this->assertSame('Receivable from supplier / advance paid', $this->service->balanceMeaning(-25));
    ...
    public function test_balance_presentation_includes_all_fields(): void
    {
        ...
        $this->assertSame('Payable to supplier', $presentation['meaning']);
    ...
    public function test_build_report_row_includes_balance_meaning(): void
    {
        ...
        $this->assertSame(125.0, $row['net_payable']);
        $this->assertSame('Payable to supplier', $row['balance_meaning']);
        $this->assertSame('positive', $row['balance_tone']);
        $this->assertSame('text-emerald-700', $row['balance_tone_class']);
    }
}
